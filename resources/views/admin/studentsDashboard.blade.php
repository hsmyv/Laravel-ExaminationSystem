...
@section('space-work')
    ...
    <table class="table mt-5">
        ...
        <tbody>
            ...
            @else
                <tr>
                    <td colspan="3">students & Answers not found!</td>
                </tr>
            @endif
        </tbody>
    </table>
            ...
            <div class="modal-content">
                ...
                <form id="editStudent">
                    ...
                    <div class="modal-body editModalAnswers">
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <input type="email" class="w-100" id="email" name="email" placeholder="Enter Student Email" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form id="deleteStudent">
                    ...
                    <div class="modal-footer">
                        <span class="error" style="color:red;"></span>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary deleteStudentButton">Delete Student </button>
                    </div>
                </form>
            </div>
        </div>
        ...
        $(document).ready(function(){
            ...
            $(".deleteButton").click(function(){
             ...
             $("#deleteStudent").submit(function(e){
                e.preventDefault();
                $('.deleteStudentButton').prop('disabled', true);
                var formData = $(this).serialize();
                $.ajax({
